...
namespace PSI
{
    ...
    constexpr size_t Item_byte_size = 18;
    // ID的长度，会随着特征维度的增加而增加，运行ss3r.py文件后会自动修改
    ...
    constexpr size_t OPRFKeyBytesNumber = Item_byte_size;
    ...
    namespace cuckoo{
        ...
        // 为大规模集合（如 2^20）提高插入尝试次数，降低 Overload 概率
        constexpr size_t cuckoo_table_insert_attempts = 20000;
        ...
        namespace cuckooparam224vs4096{
            ...
            constexpr size_t block_num = 905;
            constexpr size_t block_size = table_size/block_num;
            // 提高单桶最大集合容量以适配 -l 20 的更高峰值装载
            constexpr size_t max_set_size = 96;
        }
        ...
        // 为 -l 20（约 1,048,576 元素）与 -i 4096 提供更大的表规模
